...
public interface IBookingService
{
    ...
    Task<decimal> GetExpectedTotalAsync(int bookingId, CancellationToken ct = default);
    Task<BookingResponseDto> CreateByTypeAsync(CreateBookingByTypeDto dto, CancellationToken ct = default);
